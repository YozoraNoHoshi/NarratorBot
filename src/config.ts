...
export const DB_NAME: string =
  process.env.NODE_ENV === 'test' ? 'nfubotstoretest' : process.env.DB_NAME || 'nfubotstore';
export const DB_URI: string =
  process.env.NODE_ENV === 'test'
    ? `mongodb://localhost:27017/${DB_NAME}TEST`
    : process.env.MONGODB_URI || process.env.DB_URI || `mongodb://localhost:27017/${DB_NAME}`;
